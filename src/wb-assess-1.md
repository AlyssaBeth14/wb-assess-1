...
```
Functions help you maintain your code and reduce the amount of information you need within your code because you can reuse them.
```

**_What is the difference between `console.log` and `return`?_**

```
console.log doesn't push anything back. I can use console.log to indicate what argument I have. Return actually executes the function.
```

**_What's the difference between defining and calling a function?_**

```
Calling a function runs the code within the function and defining it simply gives it a name.
```
...
```
A string allows you to use many different kinds of characters (numbers, letters, symbols) in a sequence. 
```

**_Number_**

```
Negative and positive numbers, whole numbers and decimals, are all numbers that are included in this data type.
```
...
```
Similar to a string, except you can break up the characters to indicate different variables. Like a list. I can have a list of numbers or a list of words or a combination of the two. But it allows me to have more than one variable.
```
